...
<div class="row">
  <div class="col-lg-12">
    <h3 class="page-header"><i class="fa fa-file-text-o"></i>Facturas de <b style="color: red">Concursos</b></h3>
    <ol class="breadcrumb">
...
<div class="row">
  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" id="valores_venda" style="display: block">
    <div class="info-box brown-bg">
      ...
      <!-- Nao eh mostrado o pago eh feito no concurso. Estariamos a duplicar o valor pago -->
    </div>
  </div>
</div>
    ...
    <section class="panel panel-default">
      <div class="panel-body">
        <div class="row" style="margin-bottom: 10px">
          ...
          <div class="col-md-2">
            {{Form::open(['route'=>'listar_saida_de_concurso_mes', 'method'=>'POST'])}}
          ...
          <div class="col-md-2">
            {{Form::open(['route'=>'listar_saida_concurso_ano', 'method'=>'POST'])}}
            <div class="input-group">
          ...
          <div class="col-md-2">
            <a href="{{route('rg_saidas_de_concurso')}}" class="btn btn-primary">
