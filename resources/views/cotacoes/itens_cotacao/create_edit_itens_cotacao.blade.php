						...
						<div class="col-md-6 border">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body" id="painel_editar_motivo" style="display: none">
									{{Form::model($cotacao, ['route'=>['cotacao.update', $cotacao->id], 'method'=>'PUT'])}}
									<div class="row" id="hide_select_editar_motivo">
										<div class="col-sm-12">
											...
											<div class="input-group">
												...
												{{Form::text('old_motivo_iva_id', $cotacao->motivo_iva_id, ['hidden', 'id'=>'old_motivo_iva_id', 'disabled'])}}

												
												{{Form::text('old_aplicacao_motivo_iva', $cotacao->aplicacao_motivo_iva, ['hidden', 'id'=>'old_aplicacao_motivo_iva', 'disabled'])}}
								...
								<div class="panel-body" id="painel_novo_motivo" style="display: none">
									{{Form::open(['route'=>['cotacao.update', $cotacao->id], 'method'=>'PUT'])}}
									<div class="row">
										<div class="col-md-12">
											{{Form::label('motivo_iva_id', 'Selecione Motivo Justificativo da não aplicação de imposto')}}
											<div class="input-group">
