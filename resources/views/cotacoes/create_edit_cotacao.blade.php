  ...
  <div class="row">
    <div class="col-lg-12">
      <section class="panel panel-default">
        ...
        {{ Form::open(['route'=>'cotacao.store', 'method'=>'POST']) }}
            ...
            <div class="form-horizontal">
              ...
              <div class="col-sm-4">
                ...
                <div class="input-group">
                  ...
                  {{Form::button('<i class="fa fa-plus"></i>', ['class'=>'input-group-addon', 'data-toggle'=>'modal', 'data-target'=>'#modalCotacao', 'style'=>'width:auto; font-weight:lighter'])}}
                </div>
              </div>
        ...
        {{ Form::hidden('valor_total', null, ['class'=>'valor_total']) }}
