       ...
       <div class="col-md-3">
         ...
         <div class="row" style="margin-bottom: 8px">
           <div class="col-md-12">
             ...
             {{ Form::text('codigo_concurso', null, ['class'=>'form-control','id'=>'codigo_concurso'])}}
           </div>
         </div>
         <div class="row">
           <div class="col-md-12">
            {{ Form::label('confirmar_codigo_concurso', 'Confirmar Código do Concurso')}}
            {{ Form::text('confirmar_codigo_concurso', null, ['class'=>'form-control', 'id'=>'confirmar_codigo_concurso'])}}
          </div>
        </div>
...
<div class="panel-footer">
  <div class="row">
    ...
    <div class="col-md-6 text-right">
      <a href="{{ route('concurso.index') }}" class="btn btn-warning">Cancelar</a>
    </div>
  </div>
</div>
</section>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalCliente">
  ...
  <script text="text/javascript">
    ...
    function addRow()
    {
      var tr='<tr>'+
      '<td>'+
      '<select class="form-control descricao" name="produto_id[]" id="prod">'+
    ...
    $('tbody').on('click','.remove',function(){
      ...
      if (l==1) {
        alert('A concurso deve conter pelo menos um item');
      }else{
