                ...
                <div class="tab-content">
                  ...
                  <div id="profile" class="tab-pane active">
                    <section class="panel">
                      ...
                      <div class="panel-body bio-graph-info">
                        ...
                        <div class="row">
                          <div class="bio-row">
                            <p><span>Nome  </span>: {{ $user->first_name }} </p>
                          </div>
                          <div class="bio-row">
                            <p><span>Apelido </span>: {{ $user->last_name }}</p>
                          </div>
                          <div class="bio-row">
                          ...
                          <div class="bio-row">
                            <p><span>Mobile </span>: {{$user->telefone }}</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Phone </span>: {{$user->telefone }}</p>
                          </div>
                        </div>
                      </div>
                    </section>
                  ...
                  <div id="edit-profile" class="tab-pane">
                    <section class="panel">
                      <div class="panel-body bio-graph-info">
                        <h1> Profile Info</h1>
                        <form class="form-horizontal" role="form" enctype="multipart/form-data" action="/profiles" method="POST">
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Update Profile Image</label>
                            <div class="col-lg-6">
