      ...
      <table class="table table-striped table-advance table-hover">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group">
                <a class="btn btn-primary" href="{{route('saida.show', $saida->id)}}"><i class="icon_plus_alt2"></i></a>
                <a class="btn btn-success" href="{{route('saida.edit', $saida->id)}}"><i class="icon_check_alt2"></i></a>
