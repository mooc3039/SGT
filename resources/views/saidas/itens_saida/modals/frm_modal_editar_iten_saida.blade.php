					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								...
								{{ Form::hidden('old_quantidade', null, ['id'=>'old_quantidade']) }} <!-- old_qtd essencial para calcular a qtd incrementada ou decrementada para chamar o procedimento que actualiza o restante no iten_saidas -->
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<!-- estes dois inputs abaixo sao para efeitos de validacao da qtd no controller -->
								{{Form::hidden('qtd_referencial', null, ['placeholder' => 'Subtotal', 'class' => 'form-control', 'id'=>'qtd_referencial', 'readonly'])}}

								{{Form::hidden('qtd_referencial_min_iten_saida', null, ['placeholder' => 'Subtotal', 'class' => 'form-control', 'id'=>'qtd_referencial_min_iten_saida', 'readonly'])}}
							</div>
						</div>
