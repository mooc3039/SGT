					...
					<div class="col-md-12">
						<div class="row" >
							<div class="col-md-8" style="margin-bottom: 10px">
								<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalInserirItem" data-new_valor_total={{ $saida->valor_total }} data-new_saida_id={{ $saida->id }} data-new_aplicacao_motivo_iva={{ $saida->aplicacao_motivo_iva }}><i class="fa fa-plus"></i></button>
							</div>
							<div class="col-md-4">
					...
					<div class="col-md-6 border">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body" id="painel_editar_motivo" style="display: none">
								{{Form::model($saida, ['route'=>['saida.update', $saida->id], 'method'=>'PUT'])}}
								<div class="row" id="hide_select_editar_motivo">
									<div class="col-sm-12">
										...
										<div class="input-group">
											...
											{{Form::text('old_motivo_iva_id', $saida->motivo_iva_id, ['hidden', 'id'=>'old_motivo_iva_id', 'disabled'])}}

											
											{{Form::text('old_aplicacao_motivo_iva', $saida->aplicacao_motivo_iva, ['hidden', 'id'=>'old_aplicacao_motivo_iva', 'disabled'])}}
							...
							<div class="panel-body" id="painel_novo_motivo" style="display: none">
								{{Form::open(['route'=>['saida.update', $saida->id], 'method'=>'PUT'])}}
								<div class="row">
									<div class="col-md-12">
										{{Form::label('motivo_iva_id', 'Selecione Motivo Justificativo da não aplicação de imposto')}}
										<div class="input-group">
