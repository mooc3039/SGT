...
<td class="linha" style="width: 148px; text-align: center;">{{$venda->valor_total}}Mtn</td>
</tr>
...
<td class="linha" style="width: 148px; text-align: center;">{{(($venda->valor_total)*17)/100}}</td>
</tr>
<tr style="height: 18px;">

<td class="linha" style="width: ; height: 18px;">&nbsp;</td>
<td class="linha" style="width: ; height: 18px;text-align: right;"><strong>&nbsp;TOTAL</strong></td>
<td class="linha" style="width: 148px; text-align: center;">{{$venda->valor_iva}}Mtn</td>
</tr>
<tr style="height: 18px;">
