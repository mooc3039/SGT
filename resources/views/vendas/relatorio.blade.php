...
<h2 style="color: red; text-align: center;">N&ordm; {{$venda->id}}/{{date('Y', strtotime($venda->data))}}</h2>
</div>
</td>
</tr>
...
<td style="width: 129px; text-align: center;" class="linha">{{number_format($iten_venda->produto->preco_venda, 2)}}</td>
<td style="width: 161px; text-align: center;" class="linha">{{number_format($iten_venda->valor, 2)}}</td>
</tr>
@endforeach
</tbody>
</table>
...
<td class="linha" style="width: 148px; text-align: center;">{{number_format($venda->valor_total,2)}}Mtn</td>
</tr>
<tr style="height: 17px;">

<td class="linha" style="width: ; height: 18px;">{{$venda->motivo_justificativo_nao_iva}}</td>
<td class="linha" style="width:; height: 18px;text-align: right;"><strong>&nbsp;IVA 17%</strong></td>
<td class="linha" style="width: 148px; text-align: center;">{{number_format((($venda->valor_total)*17)/100, 2)}}</td>
</tr>
<tr style="height: 18px;">

<td class="linha" style="width: ; height: 18px;">&nbsp;</td>
<td class="linha" style="width: ; height: 18px;text-align: right;"><strong>&nbsp;TOTAL</strong></td>
<td class="linha" style="width: 148px; text-align: center;">{{number_format($venda->valor_iva,2)}}Mtn</td>
</tr>
<tr style="height: 18px;">
