      ...
      <div class="panel-body">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <table class="table table-striped table-advance table-hover" id="tbl_index_pagamentos_venda" data-order='[[ 3, "desc" ]]'>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    var titulo = "Pagamentos da Venda "+codigo_venda;   
    var msg_bottom = "Papelaria Agenda & Serviços";

    var oTable = $('#tbl_index_pagamentos_venda').DataTable( {
      "processing": true,
